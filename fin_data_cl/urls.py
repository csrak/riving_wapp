...
urlpatterns = [
    ...
    path('risks/securities/<int:exchange_id>/',views.get_securities_for_exchange,
         name='get_securities_risks'),
    path('risks/dates/<int:security_id>/', views.get_years_for_security,
         name='get_years_risks'),
    path('risks/months/<int:security_id>/<int:year>/',views.get_months_for_year,
         name='get_months_risks'),
    path('get_security_prices/', views.get_security_prices, name='get_security_prices'),
]
